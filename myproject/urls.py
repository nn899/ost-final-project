...
#   url(r'^questions/answers/(\d+)$', 'finalproject.views.view_question'),
    url(r'^questions/answers/add_answer/(\d+)$', 'finalproject.views.add_answer_login_form'),
    url(r'^questions/answers/edit_answer$', 'finalproject.views.edit_answer_login_form'),
)
